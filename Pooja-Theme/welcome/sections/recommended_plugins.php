<?php
	...
	if(!empty($pro_plugins)) {
		?>
		<h4 class="recomplug-title"><?php echo esc_html__('Pro Plugins', 'uncode-lite'); ?></h4>
		<p><?php echo esc_html__('Take Advantage of some of our Premium Plugins', 'uncode-lite'); ?></p>
						...
						<div class="version-author-info">
							<span class="version">
								<?php
									...
									printf('Version %s', esc_html($plugin['version']));
								?>		
							</span>
	...
	if(!empty($free_plugins)) {
		?>
		<h4 class="recomplug-title"><?php echo esc_html__('Free Plugins', 'uncode-lite'); ?></h4>
		<p><?php echo esc_html__('These Free Plugins might be handy for you.', 'uncode-lite'); ?></p>
		<div class="recomended-plugin-wrap">
		<?php
					...
					<div class="plugin-img-wrap">
						...
						<div class="version-author-info">
							<span class="version">
								<?php
									/* translators: %s : plugin version */
									printf('Version %s', esc_html($info->version));
								?>
								</span>
							<span class="seperator">|</span>
